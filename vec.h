...
#define DECL_VEC(vtype, type, prefix, rqc, rqd)                                                       \
    ...
    prefix vtype *vtype##_init_by_array(type *array, size_t count COMMA(rqc, rqd) INIT_PARAM_LIST(vtype, rqc, rqd)); \
...
#define DEF_VEC(vtype, type, prefix, rqc, rqd)                                                      \
    ...
    prefix vtype *vtype##_init_by_array(type *array, size_t size COMMA(rqc, rqd) INIT_PARAM_LIST(vtype, rqc, rqd)) \
    {                                                                                               \
        vtype *v = malloc(sizeof(vtype));                                                           \
        INIT_ASSIGN_FP(rqc, rqd)                                                                    \
...
#define INIT_PARAM_LIST(vtype, rqc, rqd) \
    ...
    (vtype)
#define INIT_PARAM_LIST00(vtype)
...
*/
#define STRUCT_FP_DEF(vtype, rqc, rqd) \
    CONCAT3(STRUCT_FP_DEF, rqc, rqd)   \
    (vtype)
...
#define COMMA(rqc, rqd) CONCAT3(COMMA, rqc, rqd)
#define COMMA00
#define COMMA01 ,
#define COMMA10 ,
#define COMMA11 ,
